...
ggsave(file = "graph_SRR5836473", plot = graph_SRR5836473, device = "png")
ggsave(file = "graph_SRR3824222", plot = graph_SRR3824222, device = "png")
ggsave(file = "graph_SRR5836475", plot = graph_SRR5836475, device = "png")
